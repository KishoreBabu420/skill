...
<section>
  <img loading="lazy"
    src="https://res.cloudinary.com/skill-safari/image/upload/v1650878552/website/Banner/Campus_amb_banner_exmzpt.jpg"
...
<section class="bg-ltleabt">
  <div class="container">
    <div class="row pt-5 pb-5 justify-content-center">
      <div class="col-md-12 ">
        <h2 class="top-head text-white text-center pb-5">PERKS IN STORE FOR YOU! </h2>
        <div class="row mb-3 text-white align-items-center">
          <div class="col-md-6">
            <div class="row text-white align-items-center">
              <div class="col-md-9 text-center text-md-end order-md-1 order-2">
                <h4 style="color:#fbbf40;">Certificate of Excellence</h4>
                <p class="school-para text-white  text-md-end">Get the ‘Campus Ambassador' certificate to boost your
                  resume</p>
              </div>
              <div class="col-md-3 col-12 text-md-end text-center order-md-2 order-1">
                <img loading="lazy"
                  src="https://res.cloudinary.com/skill-safari/image/upload/v1650894797/website/community%20and%20campus%20ambassador/perks1_fxld47.png"
                  class="img-fluid">
              </div>
            </div>
          </div>
          ...
          <div class="col-md-6">
            <div class="row text-white align-items-center">
              <div class="col-md-3 col-12 text-md-start text-center">
                <img loading="lazy"
                  src="https://res.cloudinary.com/skill-safari/image/upload/v1650894797/website/community%20and%20campus%20ambassador/perks2_yrrp6e.png"
                  class="img-fluid">
              </div>
              <div class="col-md-9 text-center text-md-start">
                <h4 style="color:#fbbf40;">Rewards and Incentives</h4>
                <p class="school-para text-white">Get Performance-based Paytm cash rewards and a ‘Rockstar’ certificate
                  for high performing campus Ambassador</p>
              </div>
            </div>
          </div>
        </div>
        <div class="row mb-3 text-white align-items-center">
          <div class="col-md-6">
            <div class="row text-white align-items-center">
              <div class="col-md-9 text-center text-md-end order-md-1 order-2">
                <h4 style="color:#fbbf40;">Network with the Industry’s Best</h4>
                <p class="school-para text-white text-md-end">Get direct exposure to the corporate world and a chance to
                  build meaningful connections for your professional network</p>
              </div>
              <div class="col-md-3 col-12 text-md-end text-center order-md-2 order-1">
                <img loading="lazy"
                  src="https://res.cloudinary.com/skill-safari/image/upload/v1650894797/website/community%20and%20campus%20ambassador/perks3_djmuez.png"
                  class="img-fluid">
              </div>
            </div>
          </div>
        ...
        <div class="row mb-3 text-white align-items-center">
          ...
          <div class="col-md-6">
            <div class="row text-white align-items-center">
              <div class="col-md-3 col-12 text-md-start text-center">
                <img loading="lazy"
                  src="https://res.cloudinary.com/skill-safari/image/upload/v1650894797/website/community%20and%20campus%20ambassador/perks4_hrdckq.png"
                  class="img-fluid">
              </div>
              <div class="col-md-9 text-center text-md-start">
                <h4 style="color:#fbbf40;">One of a kind Mentorship Program</h4>
                <p class="school-para text-white">An opportunity to be mentored by leading professionals at Paytm to
                  expand your skillset and grow your ingenuity</p>
              </div>
            </div>
          </div>
        </div>
        <div class="row mb-3 text-white align-items-center">
          <div class="col-md-6">
            <div class="row text-white align-items-center">
              <div class="col-md-9 text-center text-md-end order-md-1 order-2">
                <h4 style="color:#fbbf40;">Pre-Placement Interview</h4>
                <p class="school-para text-white  text-md-end">Outstanding performers will get an opportunity for
                  pre-placement interview with Paytm</p>
              </div>
              <div class="col-md-3 col-12 text-md-end text-center order-md-2 order-1">
                <img loading="lazy"
                  src="https://res.cloudinary.com/skill-safari/image/upload/v1650894797/website/community%20and%20campus%20ambassador/perks5_lddact.png"
                  class="img-fluid">
              </div>
            </div>
          </div>
...
<section class="bg-abtlay">
  <div class="container pt-5 pb-5">
    <div class="row pt-md-5 pb-md-5">
      <div class="col-md-12 text-center">
        <h2 class="top-head text-center pb-5"> About the Program </h2>
      </div>
      <div class="col-md-3 mb-4 mb-md-0 align-self-stretch d-flex">
        <div class="rounded-2 p-4" style="background:#74affc;">
          <div class="text-center pb-4">
            <img loading="lazy"
              src="https://res.cloudinary.com/skill-safari/image/upload/v1650894829/website/community%20and%20campus%20ambassador/ap1_orec4f.png"
      ...
      <div class="col-md-3 mb-4 mb-md-0 align-self-stretch d-flex">
        <div class="rounded-2 p-4" style="background:#ffc342;">
          <div class="text-center pb-4">
            <img loading="lazy"
              src="https://res.cloudinary.com/skill-safari/image/upload/v1650894829/website/community%20and%20campus%20ambassador/ap2_xarb7v.png"
              class="img-fluid" style="width: 80px;height: 80px;">
          </div>
      ...
      <div class="col-md-3 mb-4 mb-md-0 align-self-stretch d-flex">
        <div class="rounded-2 p-4" style="background:#f5916d;">
          <div class="text-center pb-4">
            <img loading="lazy"
              src="https://res.cloudinary.com/skill-safari/image/upload/v1650894829/website/community%20and%20campus%20ambassador/ap3_zoxtf1.png"
              class="img-fluid" style="width: 80px;height: 80px;">
          </div>
      ...
      <div class="col-md-3 mb-4 mb-md-0 align-self-stretch d-flex">
        <div class="rounded-2 p-4" style="background:#9c94f8;">
          <div class="text-center pb-4">
            <img loading="lazy"
              src="https://res.cloudinary.com/skill-safari/image/upload/v1650894829/website/community%20and%20campus%20ambassador/ap4_pvhua9.png"
              class="img-fluid" style="width: 80px;height: 80px;">
          </div>
        ...
        <div class="row">
          <div class="col-md-6 d-flex align-self-stretch mb-4">
            <div class="blueborder p-4">
              <p class="school-para text-white">
                Improve your leadership skills and boost career prospects
              </p>
            </div>
          </div>
          <div class="col-md-6 d-flex align-self-stretch mb-4">
            <div class="blueborder p-4">
              <p class="school-para text-white">
                Improve your communication skills, presentation skills and enhance your network
              </p>
            </div>
          </div>
          <div class="col-md-6 d-flex align-self-stretch mb-4">
          ...
          <div class="col-md-6 d-flex align-self-stretch mb-4">
            <div class="blueborder p-4">
              <p class="school-para text-white">
                Improve your managerial skills and data handling skills
              </p>
            </div>
          </div>
        </div>
    ...
    <div class="row pt-md-5 pb-5 justify-content-center align-items-center">
      ...
      <div class="col-md-8 pt-4 pt-md-0">
        <div class="blueborder p-4 mb-4">
          <h4 class="mb-0">can start the part time job/internship between 10th Feb'20 and 11th Mar'20</h4>
        </div>
        <div class="blueborder p-4 mb-4">
          <h4 class="mb-0">are available for duration of 2 months</h4>
        </div>
        <div class="blueborder p-4 mb-4">
          <h4 class="mb-0">have relevant skills and interests</h4>
        </div>
      </div>
