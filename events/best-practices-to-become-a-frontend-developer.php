  ...
  <div class="container">
    <div class="row pt-5">
      <div class="col-xl-6 text-center text-md-start">
        ...
        <h1 class="top-head  pt-3">Best practices to become a Front end developer - A beginner’s guide </h1>
      ...
      <div class="col-xl-6 pb-5 pt-lg-5 pt-0">
        <div>
          <img class="w-100"
            src="https://res.cloudinary.com/skill-safari/image/upload/v1678945982/website/events/banner_3_event_qtk4vf.png"
      ...
      <div class="col-md-6 ps-5">
        <div class="row align-items-center">
          ...
          <div class="col-md-10 col-10">
            <p class="timeline-head">Brief Introduction to Front-End Development.</p>
          </div>
        </div>
        <div class="row">
        ...
        <div class="row align-items-center">
          ...
          <div class="col-md-10 col-10">
            <p class="timeline-head">Learning Methodology for Front-End Development.</p>
          </div>
        </div>
        <div class="row">
          <div class="col-md-2 col-2">
        ...
        <div class="row align-items-center">
          ...
          <div class="col-md-10 col-10">
            <p class="timeline-head">Brief Introduction of the Summer Internship program offered by Skill Safari.</p>
          </div>
        </div>
      </div>
          ...
          <div class="accordion-item mb-3 p-4">
            ...
            <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
              ...
              <div class="accordion-body">
                <p class="school-para mb-0">Best practices to become a Front end developer - A beginner’s guide.</p>
              </div>
            </div>
          </div>
          <div class="accordion-item mb-3 p-4">
