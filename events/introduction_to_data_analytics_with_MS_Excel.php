<?php 
$title = "Introduction to Data Analytics with MS Excel";
$description = "Join the 'Introduction to Data Analytics with MS Excel' LIVE Webinar. Mr. Kishore Kammela, Co-Founder of Skill Safari, can also teach you about the significance of MS Excel in Data Analytics.";
  ...
  <div class="container">
    <div class="row pt-5">
      <div class="col-xl-6 text-center text-md-start">
        ...
        <h1 class="top-head-event pt-3">Introduction to Data Analytics with MS Excel </h1>
        ...
        <p class="school-para pt-3">Join the "Introduction to Data Analytics with MS Excel" LIVE Webinar. Mr. Kishore
          Kammela, Co-Founder of Skill Safari, can also teach you about the significance of MS Excel in Data Analytics.
        </p>
      ...
      <div class="col-md-6 ps-5">
        <div class="row align-items-center">
          ...
          <div class="col-md-10 col-10">
            <p class="timeline-head">Understanding the basics of data analytics</p>
        ...
        <div class="row align-items-center">
          ...
          <div class="col-md-10 col-10">
            <p class="timeline-head">Applying data analytics concepts to real-world scenarios</p>
        ...
        <div class="row align-items-center">
          ...
          <div class="col-md-10 col-10">
            <p class="timeline-head">Exploring essential Excel functions and formulas for data analysis</p>
        ...
        <div class="row align-items-center">
          ...
          <div class="col-md-10 col-10">
            <p class="timeline-head">Visualising data effectively with charts and graphs</p>
  ...
  <div class="container">
    <div class="row justify-content-center pb-5">
      ...
      <div class="col-lg-8 pb-md-5">
        <div class="trainee-box bg-white shadow">
          <div class="row align-items-center">
            ...
            <div class="col-md-8">
              <p class="ft-16 text-justify">Kishore has more than six years of professional experience and is highly
                ambitious and motivated. I have held various positions requiring me to create and market cutting-edge
                products with the primary goal of assisting businesses in growing while working in the education and
                operations-heavy industries.</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="container">
          <div class="row pt-5 pb-5">
            <div class="col-md-12 pt-md-5 pb-5">
              ...
              <p class="top-para text-center ">Yes! You will be certified for this program once you submit your
                assignment.
              </p>
            </div>
              ...
              <div class="certified-content">
                <div class="row  mb-4">
                  ...
                  <div class="col-lg-10 col-10">
                    ...
                    <p class="school-para">Receive an instructor signed certificate with institution’s logo to verify
                      your
                ...
                <div class="row  mb-4">
                  ...
                  <div class="col-lg-10 col-10">
                    ...
                    <p class="school-para">Add the certificate to your CV or your Resume or post it directly on
                      LInkedin. You
                ...
                <div class="row  mb-4">
                  ...
                  <div class="col-lg-10 col-10">
                    ...
                    <p class="school-para">Use your certificate to enhance your professional credibility and stand out
                      among
                      your peers!</p>
                  </div>
                </div>
              ...
              <div class="accordion" id="accordionExample">
                <div class="accordion-item mb-3 p-4">
                  <h3 class="accordion-header" id="headingOne">
                    <button class="accordion-button  pt-0 pb-0" type="button" data-bs-toggle="collapse"
                      ...
                      <h4 class="top-head-faq mb-0">What is this webinar about?</h4>
                    </button>
                  </h3>
                  <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                    data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                      <p class="school-para mb-0">This webinar is about Mastering Data Analytics with MS Excel.</p>
                    </div>
                  </div>
                </div>
                <div class="accordion-item mb-3 p-4">
                  <h3 class="accordion-header" id="headingTwo">
                    <button class="accordion-button collapsed pt-0 pb-0" type="button" data-bs-toggle="collapse"
                      ...
                      <h4 class="top-head-faq mb-0">What is the minimum system requirement needed? Do I need to install
                        any
                        extra software?</h4>
                    </button>
                  </h3>
                  <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                    ...
                    <div class="accordion-body">
                      <p class="school-para mb-0">A Processor Speed of 1.6 GHz, a minimum of 4GB RAM is preferred, and a
                        Microphone. No for this webinar, you don’t need any extra software except for the webinar
                        platform
                ...
                <div class="accordion-item mb-3 p-4">
                  ...
                  <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree"
                    data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                      <p class="school-para mb-0">You should be between 15 to 28 years of age group and must have passed
                        12th
                        grade.</p>
                    </div>
                  </div>
                ...
                <div class="accordion-item mb-3 p-4">
                  ...
                  <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour"
                    data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                      <p class="school-para mb-0">During this engaging webinar, you will discover the fundamentals of
                        data
                        analytics and learn how to leverage the power of Excel to make sense of complex data sets. </p>
                    </div>
                  </div>
                </div>
                <div class="accordion-item mb-3 p-4">
                ...
                <div class="accordion-item mb-3 p-4">
                  ...
                  <div id="collapseSix" class="accordion-collapse collapse" aria-labelledby="headingSix"
                    data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                      <p class="school-para mb-0">Yes, if you attend this webinar till the end and submit the
                        questionnaire we
      ...
      if (document.getElementById('days')) {
        ...
        let countDown = new Date('June 24, 2023 19:00:00').getTime(),
