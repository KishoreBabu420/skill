    ...
    <div class="row pt-5">
      <div class="col-xl-6 text-center text-md-start">
        ...
        <p class="school-para pt-3">Join us LIVE and learn the practices and preps to become a Full Stack Developer and
          learn how “To build a Game ” with Java Script in this workshop. At the end of the workshop, you will
    ...
    <div class="row pt-lg-5 pb-lg-5">
      ...
      <div class="col-md-6 ps-5">
        ...
        <div class="row">
          <div class="col-md-2 col-2">
            <div class="text-center pt-2 pb-2">
              <img src="https://res.cloudinary.com/skill-safari/image/upload/v1687328541/website/yellow-line_s23tds.png" class="img-fluid" alt="full stack event" Loading="lazy" title="">
            </div>
          </div>
        </div>
        <!--  -->
        ...
        <div class="row">
          <div class="col-md-2 col-2">
            <div class="text-center pt-2 pb-2">
              <img src="https://res.cloudinary.com/skill-safari/image/upload/v1687328541/website/yellow-line_s23tds.png" class="img-fluid" alt="full stack event 2" Loading="lazy" title="">
            </div>
          </div>
        </div>
        <!--  -->
        ...
        <div class="row">
          <div class="col-md-2 col-2">
            <div class="text-center pt-2 pb-2">
              <img src="https://res.cloudinary.com/skill-safari/image/upload/v1687328541/website/yellow-line_s23tds.png" class="img-fluid" alt="fullstack event" title="">
            </div>
          </div>
        </div>
        <!--  -->
            ...
            <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
              ...
              <div class="accordion-body">
                <p class="school-para mb-0">Learn the practices and preps to become a Full Stack Developer and learn how
                  “To build a Game ” with Java Script in this workshop.</p>
              </div>
            </div>
          </div>
          <div class="accordion-item mb-3 p-4">
...
if (document.getElementById('days')) {
  ...
  let countDown = new Date('May 4, 2022 20:00:00').getTime(),
