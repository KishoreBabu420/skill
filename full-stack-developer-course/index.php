    ...
    <div class="row pt-3">
      ...
      <div class="col-12 col-md-6">
        <div class="row m-2">
          ...
          <p>JavaScript on the browser, Functions and OOP Programming, Data Structures and Algorithms with JavaScript
          </p>
      ...
      <div class="col-12 col-md-6">
        <div class="row m-2">
          ...
          <p>Advanced JavaScript, Advanced CSS Working with DOM API & Local Storage, Introduction to React and React
                          ...
                          <div class="modal-body">
                            ...
                            <div class="row">
                              <div class="col-md-4">
                                <img
                                  src="https://res.cloudinary.com/skill-safari/image/upload/v1650004276/website/trainers/Sathish_dxpwrt.png"
                                  class="img-fluid" alt="full stack trainer" title="" />
                              </div>
