...
<section class="coursepg-header">
    <div  id="subnav" class="bg-white new-navdown shadow w-100">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h3 class="top-coursepgscrollhead mb-0 pt-2">Career in Data Analytics</h3>
                </div>
                <div class="col-md-10 p-0">                
                    <ul class="list-group list-group-horizontal pb-2 new-topscrolllist">
                        ...
                        <li class="list-group-item"><a class="text-decoration-none" href="#why">Why Data Analytics</a></li>
    ...
    <div class="container pt-md-0 pt-5">
        <div class="row pt-md-5 pb-md-5 justify-content-center">
            <div class="col-md-12 pb-5">
                <h1 class="text-center top-head">Why Data Analytics program ?</h1>
            </div>
                        ...
                        <div class="tab-content new-md-show" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-paynow1" role="tabpanel" aria-labelledby="pills-paynow1-tab">
                                <div class="fullbox-border p-4">
                                    <h2 class="heading-new fw-bold">Data Analytics program</h2>
