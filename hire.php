    ...
    <div class="container">
        <div class="row pt-lg-5 pb-lg-5">
            <div class="col-md-12 text-center pb-md-5 pb-4">
                <h1 class="top-head pb-3">How Students Will Be Trained?</h1>
            </div>
            ...
            <div class="col-md-6 ps-md-5 ps-3">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-10 col-10">
                        <h6 class="timeline-head">Loreum ipsum decor</h6>
                        <p class="school-para">Lorem ipsum dolor sit amet consectetur adipisicing elit. </p>
                    </div>
                </div>
                <div class="row">
