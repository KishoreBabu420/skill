    ...
    <div class="row pt-5">
      <div class="col-xl-6 text-center text-md-start">
        ...
        <p class="school-para pt-5">The best way to master React JS is by doing. That's why our internship program is
          ...
          & Tools, And become a Skilled React Developer in 6 Weeks with the Skill Safari’s Summer Internship Program
        </p>
  ...
  <div class="container">
    <div class="row pt-lg-5 pb-lg-5">
      <div class="col-md-12 text-center pb-md-5 pb-4">
        <h2 class="top-head pb-3">What you will learn?</h2>
        ...
        <div class="accordion" id="accordionExample">
            ...
            <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
              ...
              <div class="accordion-body">
                <p class="school-para mb-0">Learn the practices and preps to become a React Developer and learn how “To
                  build a Web Application” with React.JS in this Summer Internship Program.</p>
              </div>
            </div>
          </div>
          <div class="accordion-item mb-3 p-4">
          ...
          <div class="accordion-item mb-3 p-4">
            <h3 class="accordion-header" id="headingThree">
              <button class="accordion-button collapsed pt-0 pb-0" type="button" data-bs-toggle="collapse"
                ...
                <h4 class="top-head-faq mb-0">Who this program is for?</h4>
              </button>
            </h3>
          ...
          <div class="accordion-item mb-3 p-4">
            ...
            <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour"
              data-bs-parent="#accordionExample">
              <div class="accordion-body">
                <p class="school-para mb-0">Skill Safari’s Summer Internship Program( SIP ) is a 100% practical training
          ...
          <div class="accordion-item mb-3 p-4">
            <h3 class="accordion-header" id="headingFive">
              <button class="accordion-button collapsed pt-0 pb-0" type="button" data-bs-toggle="collapse"
                ...
                <h4 class="top-head-faq mb-0">Is this program meant for beginners?</h4>
              </button>
            </h3>
          ...
          <div class="accordion-item mb-3 p-4">
            <h3 class="accordion-header" id="headingSix">
              <button class="accordion-button collapsed pt-0 pb-0" type="button" data-bs-toggle="collapse"
                ...
                <h4 class="top-head-faq mb-0">How long will this course take?</h4>
              </button>
            </h3>
          ...
          <div class="accordion-item mb-3 p-4">
            <h3 class="accordion-header" id="headingSix">
              <button class="accordion-button collapsed pt-0 pb-0" type="button" data-bs-toggle="collapse"
                ...
                <h4 class="top-head-faq mb-0">How many hours per day should I commit to this program?</h4>
              </button>
            </h3>
          ...
          <div class="accordion-item mb-3 p-4">
            <h3 class="accordion-header" id="headingSix">
              <button class="accordion-button collapsed pt-0 pb-0" type="button" data-bs-toggle="collapse"
                ...
                <h4 class="top-head-faq mb-0">Will I get a certificate?</h4>
              </button>
            </h3>
