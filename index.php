    ...
    <div class="row">
      <div class="col-md-6">
        ...
        <div class="regbtn mt-4 text-md-start text-center">
          <button><a href="fullstack.php" class="text-decoration-none">Explore More</a> </button>
        </div>
      </div>
      ...
      <div class="col-md-6">
        <div class="row">
          ...
          <div class="col-md-10 pb-md-5 mb-md-3 pb-3">
            ...
            <p class="para-top">We promise you guidance from only the best. Our handpicked team of mentors provide you
            ...
            <div class="modal-content">
              <div class="modal-body">
                ...
                <div class="row">
                  ...
                  <div class="col-md-12 text-center text-md-start">
                    <p class="pt-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequuntur modi
                      asperiores placeat ex molestiae atque sed iste aspernatur expedita maxime. Fugiat, architecto
                      soluta. Enim molestiae voluptate exercitationem suscipit impedit consectetur!</p>
                  </div>
                </div>
              </div>
            </div>
