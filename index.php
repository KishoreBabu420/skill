    ...
    <div class="container">
        <div class="row pt-4 pb-5">
            <div class="col-md-12 text-center pt-3 pb-3 pb-md-5">
                ...
                <p class="top-para text-white">We want to see you succeed, and to achieve your goals, we ensure the best from us reaches you while offering:</p>
            </div>
            <div class="col-md-6">
                <div class="row">
        ...
        <div class="row pt-5">
            ...
            <div class="col-lg-8 col-md-12">
                ...
                <div class="row pt-md-5 align-items-center">
                    ...
                    <p class="course-toppara">
                 A vibrant community is the key to one’s overall development. Join the community at Skill Safari and become part of the hundreds of activities we have for you. From giveaways to coding challenges, we have everything to keep your mind busy. We also have you covered for the latest news in technology along with getting you new insights about what companies and recruiters are looking for in their candidates. So what are you waiting for? Join the adventure now!
                    <div class="col-md-12 text-center  mt-4">
                        <div class="discordbtn text-center ">
                        <a href="community.php" class="text-decoration-none"><img src="images/baba.png" class="img-fluid me-1"> Join Our Discord</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-8 pt-5 pt-md-0">
                <div class="row">
                    <div class="col-md-6 col-6 mb-3">
                        ...
                        <p class="school-para">Our students and team have collectively written over 5 million lines of code. That is more than enough to fill our webpage 100 times with content.</p>
                    </div>
                    <div class="col-md-6 col-6 mb-3">
                        <h3 class="blue-text-num">600+ projects</h3>
                        <p class="school-para">Our students have over 600 projects to their name. An indication of their skill and talent.</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 col-6 mb-3">
                        <h3 class="darkblue-text-num">10000+ hours</h3>
                        <p class="school-para">Our mentors love teaching, and an attestation to that is over 10000 hours of experience in teaching. They spend their time crafting the students to create a better future.</p>
                    </div>
                    <div class="col-md-6 col-6 mb-3">
                        <h3 class="pink-text-num">4.6/5 rating</h3>
                        <p class="school-para">How have our students rated us? 4.6 out 5, that is how good we are according to our students.</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 col-6 mb-3">
                    ...
                    <div class="col-md-6 col-6 mb-3">
                        ...
                        <p class="school-para">Our mentors have trained over 14000 students, which is a testament to their skills.  </p>
                    </div>
                </div>
            </div>
        </div>
