  ...
  <div class="container">
    <div class="row pt-md-5 align-items-center">
      <div class="col-lg-6 pt-5 text-md-start text-center">
        ...
        <ul>
          <li class="course-toppara">A full-stack developer is someone who can code and handle both the front and back
            ends of websites and applications with ease.</li>
          ...
          <li class="course-toppara">Our mentors are masters in the field themselves and offer a hands-on learning
            experience you will revel in.</li>
          <li class="course-toppara">Our full-stack developer program is designed to give you all the knowledge to
            develop web applications from scratch.</li>
          <li class="course-toppara">With our full-stack developer program, you do not have to worry about paying
            upfront. You can pay after placement.</li>

        </ul>
        </p>
        <p class="school-para pt-3">
          Traditional programs are yet to catch up with this corporate world trend completely. But we, at Skill Safari,
          know the importance of staying ahead of the curve.
        </p>

        <div class="regbtn mb-5">
          <a href="" class="text-decoration-none" data-bs-toggle="modal" data-bs-target="#exampleModal-newtop">I'm
            Interested</a>
        </div>
      ...
      <div class="col-lg-5 pb-5 mt-4 mt-md-0">
        ...
        <div class="ratio ratio-16x9">
          <iframe src="https://www.youtube.com/embed/aqw3Htucscw" title="YouTube video player" frameborder="0"
  ...
  <div class="container pt-md-0 pt-5">
    <div class="row pt-md-5 pb-md-5 justify-content-center">
      ...
      <div class="col-md-12 pb-4">
        <ul>
          <li class="school-para">Data analysts and data scientists represent two of the most in-demand, high-paying
            jobs of 21st Century</li>
          <li class="school-para">The World Economic Forum Future of Jobs Report 2020 listed these roles at number one
            for increasing demand across industries</li>
          <li class="school-para">India is currently facing a huge demand-supply gap of data science and analyst
            professionals</li>
          <li class="school-para">Billions of data is stored daily but availability of highly qualified analysts and
            data scientists is very low</li>
          <li class="school-para">Flexible career path as you get opportunity to work in different domains in various
            capacity and you will be solving complex and interesting business problems</li>
          <li class="school-para">Data being the most valuable asset to a company, Data roles play a very important
            role. They serve as trusted advisers and strategic partners to their management</li>
        </ul>
      </div>
        ...
        <nav class="pt-3">
          <div class="nav nav-tabs" id="nav-tab" role="tablist">
            <button class="nav-link active" id="nav-home-tab" data-bs-toggle="tab" data-bs-target="#nav-home"
              type="button" role="tab" aria-controls="nav-home" aria-selected="true">Month 01</button>

            <button class="nav-link" id="nav-profile-tab" data-bs-toggle="tab" data-bs-target="#nav-profile"
              type="button" role="tab" aria-controls="nav-profile" aria-selected="false">Month 02</button>

            <button class="nav-link" id="nav-contact-tab" data-bs-toggle="tab" data-bs-target="#nav-contact"
              type="button" role="tab" aria-controls="nav-contact" aria-selected="false">Month 03</button>

            <button class="nav-link" id="nav-new1-tab" data-bs-toggle="tab" data-bs-target="#nav-new1" type="button"
              role="tab" aria-controls="nav-new1" aria-selected="false">Month 04</button>

            <button class="nav-link" id="nav-new2-tab" data-bs-toggle="tab" data-bs-target="#nav-new2" type="button"
              role="tab" aria-controls="nav-new2" aria-selected="false">Month 05</button>
          </div>
        </nav>
              ...
              <div class="col-md-6">
                <div class="d-flex align-items-start pt-4 align-self-stretch">
                  <div class="nav flex-column nav-pills me-3 w-100" id="v-pills-tab" role="tablist"
                    ...
                    <button class="nav-link active" id="v-pills-week01-tab" data-bs-toggle="pill"
                      data-bs-target="#v-pills-week01" type="button" role="tab" aria-controls="v-pills-week01"
                      aria-selected="true">
                    ...
                    <button class="nav-link" id="v-pills-week02-tab" data-bs-toggle="pill"
                      data-bs-target="#v-pills-week02" type="button" role="tab" aria-controls="v-pills-week02"
                      aria-selected="false">
                    ...
                    <button class="nav-link" id="v-pills-week03-tab" data-bs-toggle="pill"
                      data-bs-target="#v-pills-week03" type="button" role="tab" aria-controls="v-pills-week03"
                      aria-selected="false">
                    ...
                    <button class="nav-link" id="v-pills-week04-tab" data-bs-toggle="pill"
                      data-bs-target="#v-pills-week04" type="button" role="tab" aria-controls="v-pills-week04"
                      aria-selected="false">
              ...
              <div class="col-md-6">
                <div class="d-flex align-items-start pt-4 align-self-stretch">
                  <div class="tab-content" id="v-pills-tabContent">
                    <div class="tab-pane fade show active" id="v-pills-week01" role="tabpanel"
                      ...
                      <div class="right-newcont">
                        ...
                        <ul>
                          <li class="school-para">UI Design and why it matters and how is it different from UX design
                            (Is it?)</li>
                    ...
                    <div class="tab-pane fade" id="v-pills-week02" role="tabpanel" aria-labelledby="v-pills-week02-tab">
                      <div class="right-newcont">
                        ...
                        <ul>
                          ...
                          <li class="school-para">In this project, you will replicate (copy) one page of a very famous
                            website.</li>

                          <li class="school-para">Add on: You get a cheat sheet of popular keyboard shortcuts of Figma
                            which will boost your speed of designing.</li>
                        </ul>
                      </div>
                    </div>
                    ...
                    <div class="tab-pane fade" id="v-pills-week03" role="tabpanel" aria-labelledby="v-pills-week03-tab">
                      <div class="right-newcont">
                        ...
                        <ul>
                          ...
                          <li class="school-para">In this project, you will use your understanding and eye to visually
                            revamp a webpage.</li>

                          <li class="school-para">You will get the opportunity to apply the fundamentals of colors
                            typography and iconography in this.</li>
                        </ul>
                      </div>
                    </div>
            ...
            <div class="row mob-faq">
              <div class="accordion" id="accordionExample">
                <div class="accordion-item p-2">
                  ...
                  <div id="collapseNewOne" class="accordion-collapse collapse show" aria-labelledby="headingNewOne"
                    data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                      <h6 class="pt-5 fw-bold">What You Will Learn</h6>

                      <ul>
                        <li class="school-para">UI Design and why it matters and how is it different from UX design (Is
                          it?)</li>
                ...
                <div class="accordion-item p-2">
                  <h2 class="accordion-header" id="headingNewTwo">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                      data-bs-target="#collapseNewTwo" aria-expanded="true" aria-controls="collapseNewTwo">
                      <h1 class="top-head-faq mb-0">
                        <span class="new-font">
                          Week 02 <br />
                  ...
                  <div id="collapseNewTwo" class="accordion-collapse collapse" aria-labelledby="headingNewTwo"
                    data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                      <h6 class="pt-5 fw-bold">What You Will Learn</h6>
                ...
                <div class="accordion-item p-2">
                  ...
                  <div id="collapseNewThree" class="accordion-collapse collapse" aria-labelledby="headingNewThree"
                    data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                      <h6 class="pt-5 fw-bold">What You Will Learn</h6>
                ...
                <div class="accordion-item p-2">
                  <h2 class="accordion-header" id="headingNewFour">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                      data-bs-target="#collapseNewFour" aria-expanded="true" aria-controls="collapseNewFour">
                      <h1 class="top-head-faq mb-0">
                        <span class="new-font">
                          Week 04 <br />
                  ...
                  <div id="collapseNewFour" class="accordion-collapse collapse" aria-labelledby="headingNewFour"
                    data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                      <h6 class="pt-5 fw-bold">What You Will Learn</h6>
                ...
                <div class="d-flex align-items-start pt-4 align-self-stretch">
                  <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist"
                    ...
                    <button class="nav-link active" id="v-pills-week01-tab" data-bs-toggle="pill"
                      ...
                      <p class="school-para mb-0">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ducimus quos
                        facilis porro voluptatem?</p>
                    </button>
                  ...
                  <div class="tab-content" id="v-pills-tabContent">
                    <div class="tab-pane fade show active" id="v-pills-week01" role="tabpanel"
                      ...
                      <div class="right-newcont">
                        ...
                        <p class="school-para pt-3">
                          Lorem ipsum dolor sit amet consectetur adipisicing elit. Mollitia eum modi, itaque expedita
                          dolores, minus sint, doloribus dolorem iste enim nisi. Dolorem reiciendis non cupiditate
                  ...
                  <div id="collapseNewOne" class="accordion-collapse collapse show" aria-labelledby="headingNewOne"
                    ...
                    <div class="accordion-body">
                      <p class="school-para mb-0">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Nulla labore illum, eligendi adipisci
                        mollitia a recusandae magni facere eveniet! Eveniet laudantium esse possimus, facere veniam
          ...
          <div class="main">
            ...
            <ul class="nav nav-pills mb-3 mt-4 new-md-show " id="pills-tab" role="tablist">
              <li class="nav-item" role="presentation">
                <button class="nav-link active" id="pills-paynow1-tab" data-bs-toggle="pill"
                  data-bs-target="#pills-paynow1" type="button" role="tab" aria-controls="pills-paynow1"
                  aria-selected="true">Pay Now</button>
              </li>
              <li class="nav-item" role="presentation">
                <button class="nav-link" id="pills-paylater1-tab" data-bs-toggle="pill"
                  data-bs-target="#pills-paylater1" type="button" role="tab" aria-controls="pills-paylater1"
                  aria-selected="false">Pay Later</button>
              </li>
              <li class="nav-item" role="presentation">
                <button class="nav-link" id="pills-payemi1-tab" data-bs-toggle="pill" data-bs-target="#pills-payemi1"
                  type="button" role="tab" aria-controls="pills-payemi1" aria-selected="false">Pay in EMI</button>
              </li>
            </ul>
            ...
            <div class="accordion priceacc mt-4 new-md-mob " id="accordionExample">
              <div class="accordion-item">
                <h2 class="accordion-header" id="headingOne">
                  <button class="accordion-button" type="button" data-bs-toggle="collapse"
                    data-bs-target="#collapseOne-newly1" aria-expanded="true" aria-controls="collapseOne-newly1">
                    Pay Now
                  </button>
                </h2>
              ...
              <div class="accordion-item">
                <h2 class="accordion-header" id="headingTwo">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                    data-bs-target="#collapseTwo-newly1" aria-expanded="false" aria-controls="collapseTwo-newly1">
                    Pay Later
                  </button>
                </h2>
                <div id="collapseTwo-newly1" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                  data-bs-parent="#accordionExample">
                  <div class="accordion-body">
                    <div class="accordion-body">
                      <h2 class="heading-new fw-bold">Full Stack Developer</h2>
              ...
              <div class="accordion-item">
                <h2 class="accordion-header" id="headingThree">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                    data-bs-target="#collapseThree-newly1" aria-expanded="false" aria-controls="collapseThree-newly1">
                    Pay In EMI
                  </button>
                </h2>
                <div id="collapseThree-newly1" class="accordion-collapse collapse" aria-labelledby="headingThree"
                  data-bs-parent="#accordionExample">
                  <div class="accordion-body">
                    <div class="accordion-body">
                      <h2 class="heading-new fw-bold">Full Stack Developer</h2>
          ...
          <div class="item">
            <div class="row align-items-center">
              <div class="col-md-6">
                <h2 class="text-left">Content Management System (CMS)</h2>
                <p class="cms pt-3">
                  Wordpress and Drupal would be the best examples. Usingthe CMS users must be able to design a web page
                  using the drag and drop method. Usersshould be ableto add textual or media content into placeholders
                  that
                  are attached to locations on the web page using drag and drop method.
                </p>
              </div>
            ...
            <div id="collapseEleven" class="accordion-collapse collapse" aria-labelledby="headingFive"
              ...
              <div class="accordion-body">
                <p class="school-para mb-0">
                  ...
                  SAST tests general aptitude, general vocational aptitude, professional intelligence, and professional
