    ...
    <div class="row pt-5 mx-auto justify-content-center">
      ...
      <div class="col-md col-sm-3 col-6 pt-md-0 pt-4">
        ...
        <ul class="list-group">
          ...
          <li class="list-group-item"><a class="text-decoration-none"
              href="https://skillsafari.in/terms-and-conditions">Terms and Condition</a></li>
          <li class="list-group-item"><a class="text-decoration-none"
...
<!-- bootstrap -->
<script async src="<?php echo $bootstrapJS; ?>"></script>
<!-- carousel -->
<script async src="https://cdnjs.cloudflare.com/ajax/libs/jquery/2.1.3/jquery.min.js"></script>
<script async src="<?php echo $owlCarouselJS; ?>" type="text/javascript"></script>
<script async src="<?php echo $parsleyJS; ?>"></script>
<script async src="https://cdn.jsdelivr.net/npm/typed.js@2.0.12"></script>
<script async src="<?php echo $customJS; ?>"></script>

<!-- Linkedin insight tag -->
<script type="text/javascript">
_linkedin_partner_id = "4968641";
...
<noscript>
  <img height="1" width="1" style="display:none;" alt=""
    src="https://px.ads.linkedin.com/collect/?pid=4968641&fmt=gif" />
</noscript>
