...
<section class="bg-partners py-5">
  <div class="container">
    ...
    <div class="owl-carousel pb-2" id="partner-carouselOne">
      <div class=" text-center">
        <div class="partner__logo-container p-2">
          ...
          <img src="https://res.cloudinary.com/skill-safari/image/upload/v1650549941/website/company-logo/3_udsdou.png"
            alt="zomato" class="img-fluid" loading="lazy">
          </a>
        </div>
      </div>
      <div class=" text-center">
      ...
      <div class=" text-center">
        <div class="partner__logo-container p-2">
          ...
          <img src="https://res.cloudinary.com/skill-safari/image/upload/v1650549939/website/company-logo/7_tece5d.png"
            alt="OLA" class="img-fluid" loading="lazy">
          </a>
        </div>
      </div>
      <div class=" text-center">
        <div class="partner__logo-container p-2">
          ...
          <img src="https://res.cloudinary.com/skill-safari/image/upload/v1650549939/website/company-logo/4_pxnskh.png"
            alt="Dream 11" class="img-fluid" loading="lazy">
          </a>
        </div>
      </div>
      <div class=" text-center">
        <div class="partner__logo-container p-2">
          <a href="https://www.globallogic.com/in/" target="_blank">
      ...
      <div class=" text-center">
        <div class="partner__logo-container p-2">
          ...
          <img src="https://res.cloudinary.com/skill-safari/image/upload/v1650549939/website/company-logo/8_jdkvvy.png"
            alt="Black Rock" class="img-fluid" loading="lazy">
          </a>
        </div>
      </div>
      <div class=" text-center">
        <div class="partner__logo-container p-2">
          <a href="https://phicode.io/" target="_blank">
      ...
      <div class=" text-center">
        <div class="partner__logo-container p-2">
          <a href="https://www.elhaa.com/" target="_blank">
    ...
    <div class="owl-carousel" id="partner-carouselTwo">
      <div class=" text-center">
        <div class="partner__logo-container p-2">
          <a href="https://bewelldigital.com/" target="_blank">
      ...
      <div class=" text-center">
        <div class="partner__logo-container p-2">
          <a href="https://www.dafidy.com/" target="_blank">
          <img src="https://res.cloudinary.com/skill-safari/image/upload/v1650549940/website/company-logo/20_gqwkc9.png"
            alt="Dafidy" class="img-fluid" loading="lazy">
          </a>
        </div>
      </div>
      <div class=" text-center">
        <div class="partner__logo-container p-2">
          <a href="https://draup.com/" target="_blank">
      ...
      <div class=" text-center">
        <div class="partner__logo-container p-2">
          <a href="https://www.gharoffice.com/" target="_blank">
          <img src="https://res.cloudinary.com/skill-safari/image/upload/v1650549941/website/company-logo/23_alrqmc.png"
            alt="Gharoffice" class="img-fluid" loading="lazy">
          </a>
        </div>
      </div>
      <div class=" text-center">
        <div class="partner__logo-container p-2">
          <a href="http://www.finacus.co.in/" target="_blank">
      ...
      <div class=" text-center">
        <div class="partner__logo-container p-2">
          ...
          <img src="https://res.cloudinary.com/skill-safari/image/upload/v1650549941/website/company-logo/1_k6vqne.png"
            alt="Paytm" class="img-fluid" loading="lazy">
          </a>
        </div>
      </div>
      <div class=" text-center">
        <div class="partner__logo-container p-2">
          <a href="https://vaeso.com/" target="_blank">
