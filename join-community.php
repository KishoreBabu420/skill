...
<section class="bannersection">
  <img src="https://res.cloudinary.com/skill-safari/image/upload/v1650878552/website/Banner/community_banner_o6fsey.jpg" alt="Learn & earn community">
</section>
  ...
  <div class="container">
    <div class="row pt-5 pb-md-5 mx-auto">
      ...
      <div class="col-md-6 text-start">
        ...
        <div class="regbtn mb-5 mt-lg-5 text-center">
    ...
    <div class="row  pb-md-5 mx-auto">
      ...
      <div class="col-md-6 text-start">
        ...
        <p class="school-para pt-3">
          ...
          <br>
          Want to change the way you learn? Become a part of the Skill Safari community and become part of a new era of
