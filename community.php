...
<section class="bg-eventssection pb-5 position-relative">
    <div class="container">
        <div class="row pt-lg-5">
            <div class="col-md-12 text-center pb-5">
                <h1 class="top-head">Ongoing Events</h1>
            </div>
                        ...
                        <div class="ps-3 pe-3 pt-2">
                            <div class="row">
                                <div class="col-md-8 col-8">
                                    ...
                                    <h1 class="event-boxhead pt-3">Sales <br> Workshop</h1>
                                    <p class="school-para">Mohit Ahuja <br>Ex – Zomato, Curefit, RadYes</p>
                                </div>
                                <div class="col-md-4 col-4 text-end pt-3">
                                    <div class="pricetag-strike pt-3"><strike style="color:#888;font-size:14px;">₹ 1290</strike><br>₹ 1000</div>
                                </div>
                            </div>
