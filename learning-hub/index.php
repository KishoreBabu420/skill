    ...
    <div class="row align-items-center">
      <div class="col-lg-7">
        <div class="container">
          ...
          <div class="py-3">
            <p class="date-sec pt-3"><span class="p-1"><strong>Next Batch Starts:</strong> September 04<sup>th</sup>
                2023</span>
          </div>
          <div class="py-3">
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12 pt-4 pb-2 text-center">
        <h2 class="text-center top-head">We are accredited by</h2>
      </div>
    </div>
        ...
        <div class="iconbox-small text-center">
          <div class="icon-container">
            <img
              ...
              alt="100% Placement Guarantee" class="img-fluid">
          </div>
        ...
        <div class="iconbox-small text-center">
          <div class="icon-container">
            <img
              ...
              alt="7 Months Live Course" class="img-fluid">
          </div>
        ...
        <div class="iconbox-small text-center">
          <div class="icon-container">
            <img
              ...
              alt="1 - 1 Mentorship support" class="img-fluid">
          </div>
    ...
    <div class="row justify-content-between">
      <aside class="col-lg-3 sidebar course-sidebar d-none d-lg-block">
        <div class="card px-3 py-2 border-0 rounded-3 shadow">
          <h3 class="p-2 text-center advantage-card shadow">How
            <span><img src="https://res.cloudinary.com/skill-safari/image/upload/v1689931206/2.0-logo_rie3fo.webp"
                alt="Alchemyst2.0 logo" width="200"></span> works
          </h3>
          <hr />
          <ul class="px-3">
            <li class="my-3">
              <a href="#advantage" class="course__sidebar-link advantage">
            ...
            <li class="my-3">
              <a href="#course-work" class="course__sidebar-link course-work">
                <div class="text-center pt-2 pb-2">
                  <img
        ...
        <section class="card p-3 my-2 border-0 rounded-3 shadow my-4 hiring-partners" id="hiring-partners">
          <div class="container mb-4">
            ...
            <div class="obl-description mb-4">
              <p class="h4 text-center p-3 my-2 border-0 rounded-3 advantage-card">
          ...
          <div class="container mt-4 pt-4 d-block d-lg-none">
            <div class="card border-0 shadow rounded-2 px-2 py-4 my-3">
              <div class=" obl-feature row align-items-center">
                ...
                <div class="col-10">
                  <h4 class="timeline-head">Collaborative Learning</h4>
                  <p class="school-para">Where students have the opportunity to talk and learn with their peers and
                    industry
                    experts.
            ...
            <div class="card border-0 shadow rounded-2 px-2 py-4 my-3">
              <div class=" obl-feature row align-items-center">
                ...
                <div class="col-10">
                  <h4 class="timeline-head">Real-Time Learning</h4>
                  <p class="school-para">As our sessions are live, students can contribute their ideas and opinions in
                    each
                    session effectively.
                  </p>
                </div>
            ...
            <div class="card border-0 shadow rounded-2 px-2 py-4 my-3">
              <div class=" obl-feature row align-items-center">
                ...
                <div class="col-10">
                  <h4 class="timeline-head">Goal Based Learning</h4>
                  <p class="school-para">As our sessions are live, students can contribute their ideas and opinions in
                    each
                    session effectively.
                  </p>
            ...
            <div class="card border-0 shadow rounded-2 px-2 py-4 my-3">
              <div class=" obl-feature row align-items-center">
                ...
                <div class="col-10">
                  <h4 class="timeline-head">Accountability</h4>
                  <p class="school-para">We also track quality measures and analyze performance indicators that meet the
                    needs of companies.
                  </p>
                </div>
              </div>
            ...
            <div class="card border-0 shadow rounded-2 px-2 py-4 my-3">
              <div class=" obl-feature row align-items-center">
                ...
                <div class="col-10">
                  <h4 class="timeline-head">Networking</h4>
                  <p class="school-para">Students are exposed to industry wide experts, allowing them to create a strong
                    network.
                  </p>
                </div>
              </div>
            ...
            <div class="col-md-12 mt-lg-5 pt-5 pb-md-5">
              <div class="regbtn text-center">
                <a href="https://meet.zoho.in/XYL1GTkpkE" class="text-decoration-none" target="_blank">Register</a>
              </div>
            </div>
          </div>
        </section>
        <!-- recruitment essentials program -->
        <section class="card p-3 my-2 border-0 rounded-3 shadow my-4 hiring-partners" id="placements">
          <div class="container">
            <div class="section__title-container p-2">
              <h2 class="section-title">Stage 3: Recruitment Essentials Program</h2>
              <hr>
            </div>
            <div class="row align-items-center justify-content-center">
              <div class="col-12 col-sm-6 col-lg-4">
                <div class="card-body advantage-card p-3 my-2 border-0 rounded-3 text-center shadow">
                  ...
                  <p class="section__card-description school-para">
                    Get our placement mentor’s help in building a beautiful Online Portfolio, LinkedIn profile and
                    Resume.
                  </p>
                </div>
              </div>
              <div class="col-12 col-sm-6 col-lg-4">
                <div class="card-body p-3 my-2 border-0 rounded-3 text-center advantage-card shadow ">
                  <div class="section__logo-container">
                    <img
              ...
              <div class="col-12 col-sm-6 col-lg-4">
                <div class="card-body p-3 my-2 border-0 rounded-3 text-center advantage-card shadow">
                  ...
                  <p class="section__card-description school-para">
                    Regular placement webinars are planned for you to get the most out of cracking any recruitment
                    formats
                    during this time.
                  </p>
                </div>
...
//Home TYpe OBL,
let typed = new Typed('.intensive-courses', {
  strings: [
