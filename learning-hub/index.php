  ...
  <div class="container">
    ...
    <div class="map-img-container d-none d-lg-block">
      <img src="https://res.cloudinary.com/skill-safari/image/upload/v1683626574/placement_roadmap_gqrihy.webp"
        alt="alchemyst-career-roadmap" class="img-fluid">
    </div>
    <ul class="programlisted-block ps-0 d-lg-none">
      <li class="bg-white border-1 rounded-3 shadow">
        <span class="scpan me-2"><i class="fas fa-check-circle" aria-hidden="true"></i></span>
        <span class="boxedtitle text-start">Enroll to Alchemyst 2.0</span>
      </li>
      <li class="bg-white border-1 rounded-3 shadow">
        <span class="scpan me-2"><i class="fas fa-check-circle" aria-hidden="true"></i></span>
        <span class="boxedtitle text-start">Complete Fundamentals Phase</span>
      </li>
      <li class="bg-white border-1 rounded-3 shadow">
        <span class="scpan me-2"><i class="fas fa-check-circle" aria-hidden="true"></i></span>
        <span class="boxedtitle text-start">Choose a Suitable Career track</span>
      </li>
      <li class="bg-white border-1 rounded-3 shadow">
        <span class="scpan me-2"><i class="fas fa-check-circle" aria-hidden="true"></i></span>
        <span class="boxedtitle text-start">Get Trained in career track selected</span>
      </li>
      <li class="bg-white border-1 rounded-3 shadow">
        <span class="scpan me-2"><i class="fas fa-check-circle" aria-hidden="true"></i></span>
    ...
    <div class="card border-0 shadow rounded-2 px-2 py-4 my-3">
      <div class=" obl-feature row align-items-center">
        ...
        <div class="col-10">
          ...
          <p class="school-para">Where students have the opportunity to talk and learn with their peers and industry
            experts.
    ...
    <div class="card border-0 shadow rounded-2 px-2 py-4 my-3">
      <div class=" obl-feature row align-items-center">
        ...
        <div class="col-10">
          ...
          <p class="school-para">As our sessions are live, students can contribute their ideas and opinions in each
            session effectively.
          </p>
        </div>
      </div>
