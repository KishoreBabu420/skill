...
<div class="course-content my-3 py-3">
  <div class="container">
    <section id="career tracks">
      <div class="section-title-container py-2 my-2 text-center ">
        <h2 class="section-title">Choose your Career Tracks</h2>
      </div>
      <div class="row align-items-center justify-between">
        <div class="col-12 col-md-4">
          <div class="card-body p-3 my-2 border-0 rounded-3 shadow">
