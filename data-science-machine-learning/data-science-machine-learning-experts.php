    ...
    <div class="row align-items-center pt-md-3 justify-content-center">
      <div class="col-md-3 col-6 mb-4">
        <div class="iconbox-small text-center">
          ...
          <p class="icontitle-head pt-3">100% Placement Assistance</p>
        </div>
      </div>
      <div class="col-md-3 col-6 mb-4">
        <div class="iconbox-small text-center">
  ...
  <div class="container">
    ...
    <div class="row justify-content-around mt-5">
      <div class="col col-lg-4 ">
        <div class="card pricing-card-Dsml bg-hero text-white">
          <div class="card-body">
            <h5 class="card-title text-center h3 mb-3 ">Online Program Fees</h5>
            <p class="h2 text-center mb-3"><del><small>Rs 80,000/-</small></del></br> ₹40,000 + GST</p>
            <ul>
              <li class=" mb-3">EMI options are available with 0% interest</li>
              <hr>
              <li class="mb-3 p">3,6,9 Months based on CIBIL Score </li>
            </ul>
          </div>
        </div>
      </div>
      <div class="col col-lg-4">
        ...
        <div class="card pricing-card-Dsml bg-hero text-white">
          <div class="card-body">
            <h5 class="card-title text-center h3 mb-3 ">Offline Program Fees</h5>
            <p class="h2 text-center mb-3"><del><small>Rs 1,30,000/-</small></del> </br>₹65,000 + GST</p>
            <ul>
              <li class=" mb-3">EMI options are available with 0% interest</li>
              <hr>
              <li class="mb-3 p">3,6,9 Months based on CIBIL Score </li>
  ...
  <div class="container">
    <div class="row  pt-5 pb-5">
      <div class="col-lg-12 text-center">
        <h2 class="text-white top-head">Want to know more about Data Science & Machine Learning?</h2>
