												...
												<div id="owl-demo-mobnew" class="owl-carousel owl-theme">
													<div class="item bg-white mt-3 pb-5 ps-md-2 pe-md-2">                        
															<div class="bbt">
																	<div class="row">
																			<div class="col-xl-12">
																					<img src="images/Testimonials/Selvakumar1.jpg" class="img-flui w-100" alt="" title="">
																			</div>
...
Now I have a good exposure on building a website and knowledge over full stack technology. During my training period I developed various projects, like tic-tac toe, quote generator, To-do checklist, e-commerce. I got placed in a company through the interview provided by Skill Safari." </p>
													...
													<div class="item bg-white mt-3 pb-5 ps-md-2 pe-md-2">
															<div class="bbt">
																	<div class="row">
																			<div class="col-xl-12">
																					<img src="images/Testimonials/krishnakumar1.jpg" class="img-flui w-100" alt="" title="">
																			</div>
																			<div class="col-xl-12 ps-4 pe-4">
													...
													<div class="item bg-white mt-3 pb-5 ps-md-2 pe-md-2">                        
															<div class="bbt">
																	<div class="row">
																			<div class="col-xl-12">
																					<img src="images/Testimonials/Aniket1.jpg" class="img-flui w-100" alt="" title="">
																			</div>
																			<div class="col-xl-12 ps-4 pe-4">
													...
													<div class="item bg-white mt-3 pb-5 ps-md-2 pe-md-2">
															<div class="bbt">
																	<div class="row">
																			<div class="col-xl-12">
																					<img src="images/Testimonials/Punit1.jpg" class="img-flui w-100" alt="" title="">
																			</div>
																			<div class="col-xl-12 ps-4 pe-4">
																					<p class="school-para pt-4">"I have got opportunity to do a course with skill safari and through that i enhanced my skill and got placed in several company." </p>
																					<div class="starrating pt-1">
																							<span><i class="fas fa-star"></i></span>
																							<span><i class="fas fa-star"></i></span>
																							<span><i class="fas fa-star"></i></span>
																					...
																					<h6 class="studentname pt-3 mb-0">Punit Kumar Mishra</h6>
																					<!-- <p class="studentdest pt-1">TCS, Kochi</p> -->
																			</div>
																	</div>
															</div>
